...
public class PutDemo {  
     ...
     public static void main(String[] args) throws Exception  {  
         ...
         // String remote="hdfs://localhost:9000/lin/in1/1.txt"; //hdfs上的路径  
         String uri="hdfs://localhost:9000/";   //hdfs 地址  
         String local = "/home/hadoop/Desktop/data/uav/TestPicture/DSC05613.JPG";
//         String local="C:/Users/Administrator/Desktop/a.txt";  //本地路径  
         String remote = "hdfs://localhost:9000/user/hadoop/OutPutTest/";
//         String remote="hdfs://192.168.0.151:8020/Workspace/houlinlin";  
        ...
        // getFile(conf ,uri,"","hdfs://192.168.0.151:8020/Workspace/houlinlin/a.txt");  
         //copyFile(conf,uri,,"hdfs://192.168.0.151:8020/Workspace/houlinlin/file/apply/2014/8a8380c7459dd8b90145a1fafb500235");  
